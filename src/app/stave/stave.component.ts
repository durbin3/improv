...
export class StaveComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sheet = new Sheet(Key.fromString("C"),TimeSignature.fromString("6/8"),notes);
    ...
    new Sheet(Key.fromString("D"),TimeSignature.fromString("3/4"),notes).applyToStave(vf2)
  }
